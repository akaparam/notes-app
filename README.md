...
```
git clone https://github.com/akaparam/notes-app
cd notes-app
npm i
```
## Usage
...
If you got any good ideas about this project, feel free to reach out to me on [X](https://x.com/akaparam). Elif, found a bug? Feel free to open an issue.
